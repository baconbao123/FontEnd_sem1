...
function NobelPrizes() {
  ...
  const imgBaseUrl="../NobelPrizes/img-icon";
  useEffect(() => {
    const data = async () => {
      const dataInfo = [
        {
                    ...
                    {item.nobelPrize.map((prize, i) => {
                       if (prize.status === "active") {
                        const icon = imgIcon.find(
                          (icon) => icon.id.toLowerCase() === prize.namePrize.toLowerCase()
                        );
                        ...
                        return (
                          ...
                          >
                            ...
                            >
                              ...
                              {icon && <img src={require(`../NobelPrizes/img-icon/${iconSrc}`)} width={100} height={110} alt="img-iocn"  className="rounded-circle"/>}
                            </div>
                          </Link>
                        );
                      }
