  ...
  const posts = [
    {
      ...
      subtitlePost: 'Can you match the right peace laureate with the right accomplishment? Have a try!'
    },
    {
      imgPost: post2,
      timePost: '6/14/2023',
      ...
      <div className="overlay">
        ...
        <section className="container page-container text-light text-center">
          <div className="col-md-10 col-lg-7 m-auto">
            ...
            <p className="mb-5 text-container">Between 1901 and 2022, the Nobel Prizes and the Sveriges Riksbank Prize in Economic Sciences in Memory of Alfred Nobel were awarded 615 times to 989 people and organisations. With some receiving the Nobel Prize more than once, this makes a total of 954 individuals and 27 organisations. Below, you can view the full list of Nobel Prizes and Nobel Prize laureates.</p>
          </div>
          {/* category-item */}
          ...
          {posts.slice(0, numPosts).map((post, index) => (
            <div className="col-md-6 col-lg-6" key={index}>
              <a href="#" className="card">
                <img src={post.imgPost} className="card-img" alt={post.titlePost} />
