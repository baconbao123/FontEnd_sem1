...
import AD_modal_password from '../AD_component/AD_modal_password';
  ...
  return (
    <div className='AD-nav-content AD-nav-hidden'>
      ...
      <section className='AD-nav-container'>
        ...
        <div className={`d-flex justify-content-center ${page==='Admin'?'d-block':'d-none'}`}>

          <Button ref={showModalButoon} className=' me-3   mt-5'>Change Password</Button>
