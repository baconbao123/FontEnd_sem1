...
export default function AD_modal({
  title,
  show,
  value,
  Load,
  ...
  return (
    <>
      ...
      >
        ...
        <Form
          onSubmit={value ? updateperson : addperson}
          ...
          <Modal.Body>
            ...
            <Row className="mt-4">
              <Form.Group>
                ...
                />
                {pdfemty && value && pdf && (
                  <a target="_blank" href={`${URL}/api/pdfs/` + pdf}>
                    {pdf}
                  </a>
                )}
              </Form.Group>
            ...
            <Row className="mt-4">
              <Form.Group>
                ...
                {imgemty &&
                  ...
                  imgName &&
                  imgName.length > 0 &&
                  imgName.map((item, index) => handleShowImg(item, index))}
              </Form.Group>
            </Row>
