...
// Khởi tạo các biến
  ...
  const [filters, setFilters] = useState({
   ...
   date_post: { operator:FilterOperator.AND, constraints: [{value: null, matchMode: FilterMatchMode.DATE_IS}] },
  ...
  const [statusName]=useState(['success','danger']);
        ...
        <Col lg={10} md={10} className='bg-content'>
          ...
          <section className='card'>
            ...
            <Column selectionMode="multiple" headerStyle={{ width: '3rem' }}></Column>
              ...
              <Column field='date_post                                                                                          ' header='post date' sortable filter  dataType='date'  style={{ minWidth: '12rem' }}   />
